...
function updateUserPasswordController(token:string,userId:string,userPassword:UpdateUserPasswordProps){
...
export function useUpdateUserPassword(){
    ...
    return useMutation({
        ...
        mutationFn:(userPassword:UpdateUserPasswordProps)=>updateUserPasswordController(token,userId,userPassword),
    })
}
