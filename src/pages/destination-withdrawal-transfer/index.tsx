 ...
 <ul style={{margin:'0',padding:'0'}}>
    {Array.from({length:5},(index,value)=>(
        <li className={liStyle} key={value}>
            <BankIcon/>
            <div style={{width:'100%'}}>
                <p style={{  color: "var(--Typography-Primary, #F5F9FC)",
  textAlign: "right",
  fontFamily: '"Abar Low"',
  fontSize: "14px",
  fontStyle: "normal",
  fontWeight: 600,
  lineHeight: "normal",
  letterSpacing: "-0.5px",margin:'0',padding:'0'}}>
    فرزاد بخشی زاده
  </p>
  <p style={{margin:'0',padding:'0',  color: " #F5F9FC",
  textAlign: "right",
  fontSize: "12px",
  fontStyle: "normal",
  fontWeight: 400,
  lineHeight: "normal",opacity:'0.8',marginTop:'5px'}}>
    ۶۲۱۹ ۸۳۴۵ ۳۴۵۳ ۳۴۵۶
  </p>
            </div>
            <DotsIcon/>
