...
interface ChangeMobileDrawerProps {
  openDrawer: boolean;
  error: boolean;
  closeDrawer: () => void;
}

const ChangeMobileDrawer: FunctionComponent<ChangeMobileDrawerProps> = (props) => {
    ...
    >
      <Stack className={classes.content}>
        ...
        <Typography color='text.secondary' variant='subtitle2' mt={1} textAlign='center' px={4}>
          {error
            ? 'کاربر گرامی، شماره تلفن همراه شما تغییر نیافت. مجددا تلاش کنید.'
            : 'کاربر گرامی، شماره تلفن همراه شما با موفقیت تغییر یافت.'}
        </Typography>
...
export default ChangeMobileDrawer;
