...
interface ChangeUserNameDrawerProps {
  openDrawer: boolean;
  error: boolean;
  closeDrawer: () => void;
}

const ChangeUserNameDrawer: FunctionComponent<ChangeUserNameDrawerProps> = (props) => {
    ...
    >
      <Stack className={classes.content}>
        ...
        <Typography color='text.secondary' variant='subtitle2' mt={1} textAlign='center' px={4}>
          {error
            ? 'کاربر گرامی، نام کاربری شما تغییر نیافت. مجددا تلاش کنید.'
            : 'کاربر گرامی، نام کاربری شما با موفقیت تغییر یافت.'}
        </Typography>
...
export default ChangeUserNameDrawer;
